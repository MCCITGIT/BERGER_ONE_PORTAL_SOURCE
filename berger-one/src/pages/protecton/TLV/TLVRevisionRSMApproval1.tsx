...
const TLVRevisionRSMApproval1 = () => {
    ...
    const [filterData, setFilterData]: any = useState({ depotCode: '', terrCode: '', billToCode: '', dealerCode: '', dealerName: '', mainStatus: 'PENDING', aprvStatus: 'PENDING_RSM' });
...
export default TLVRevisionRSMApproval1