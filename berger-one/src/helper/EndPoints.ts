...
const ALL_ENDPOINTS = {
    ...
    GetPotentialTrackingDeliverySchedule: BASE_ENDPOINTS.v1 + BASE_ENDPOINTS.ProtectonPotentialLead + 'GetPotentialTrackingDeliverySchedule',
    PTDeliveryScheduleSubmit: BASE_ENDPOINTS.v1 + BASE_ENDPOINTS.ProtectonPotentialLead + 'PTDeliveryScheduleSubmit',
